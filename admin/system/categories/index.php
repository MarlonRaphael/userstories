    ...
    <section>
        ...
        if (!$readSes->getResult()):
            ...
            foreach ($readSes->getResult() as $ses):
                ...
                $readCats = new Read;
                $readCats->ExeRead("categoria", "WHERE category_parent = :parent", "parent={$category_id}");
                ...
                <section>
                    ...
                    <?php
                    $readSub = new Read;
                    $readSub->ExeRead("categoria", "WHERE category_parent = :subparent", "subparent={$category_id}");
