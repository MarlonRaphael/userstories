        ...
        <form action = "" method = "post" name = "UserCreateForm">
            ...
            <div class="label_line">
                ...
                <label class="label_medium">
                    ...
                    <select name = "user_level" title = "Selecione o nível de usuário" required hidden="">
                        <option value = "" hidden="">Selecione o Nível</option><!-- 
                        ...
                        <option value="3" hidden selected="">user</option>
                    </select>
                </label>
